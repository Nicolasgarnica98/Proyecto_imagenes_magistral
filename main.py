...
ax[0][0].imshow(io.imread(df_test_normal[np.random.randint(0,len(df_test_normal))]),cmap='gray')
ax[0][0].axis('off')
ax[1][0].imshow(io.imread(df_test_pneumonia[np.random.randint(0,len(df_test_pneumonia))]),cmap='gray')
ax[1][0].axis('off')
ax[2][0].imshow(io.imread(df_test_normal[np.random.randint(0,len(df_test_normal))]),cmap='gray')
ax[2][0].axis('off')
ax[3][0].imshow(io.imread(df_test_pneumonia[np.random.randint(0,len(df_test_pneumonia))]),cmap='gray')
ax[3][0].axis('off')
